...
namespace Vrote_Diana_Laborator2.Models
{
    public class BookCategoriesPageModel:PageModel
    {
        ...
        public void PopulateAssignedCategoryData(Vrote_Diana_Laborator2Context context, Book book)
        {
        ...
        public void UpdateBookCategories(Vrote_Diana_Laborator2Context context,string[] selectedCategories, Book bookToUpdate)             
        {                 
